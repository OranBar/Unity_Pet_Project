...
/// Extensions for LINQ Enumerable types
/// </summary>
public static class LINQEnumerableEx
{
    ...
    */
	...
	public static IEnumerable<TOut> Zip<TIn1, TIn2, TOut>(this IEnumerable<TIn1> in1, IEnumerable<TIn2> in2, Func<TIn1, TIn2, TOut> func)
	{
		return in1.Combine(in2, func);
	}
